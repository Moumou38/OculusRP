...
public class ExampleHUD : VRGUI 
{
	...
	public override void OnVRGUI()
	{
		...
		if(pick != null && pick.treasure && pick.picture != null ) GUI.DrawTexture(new Rect(Screen.width * 0.6f, Screen.height * 0.15f, Screen.width * 0.25f, Screen.height * 0.2f ), tex, ScaleMode.ScaleToFit, true, 0);
